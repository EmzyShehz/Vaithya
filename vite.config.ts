...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Vaithya - Blood Test Tracking',
        short_name: 'Vaithya',
        description: 'Track your blood test results, monitor biomarkers, and achieve your health goals',
        theme_color: '#337e51',
        ...
        shortcuts: [
          {
            ...
            url: '/?tab=results',
            icons: [{ src: '/icons/shortcut-results.png', sizes: '96x96' }]
          },
          {
            name: 'Health Goals',
            short_name: 'Goals',
